...
class Transformer:
    """
    manipulates dataframe(s) to make them suitable for plotting
    """
    ...
    @staticmethod
    def age_distribution_maker(dfs, age):
        concat_df = pd.concat(dfs)
        return concat_df[concat_df.age < age]
...
chat_id = -927780322 # chat kc-target
...
def dag_sim_shiriaev_task_9_2(): 
    ...
    # # make a list of objects to be plotted
    # to_plot_objects = [shared_dau_os,
    #                ctr,
    #                views,
    #                ads_percentage,
    #                retention,
